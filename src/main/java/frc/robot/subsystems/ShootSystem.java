...
public class ShootSystem extends SubsystemBase {
    ...
    public ShootSystem() {
        ...
        // traversalEncoder = traversalMotor
    ...
    public void shoot(double power) {
        double traversalPIDOUt = motorController.calculate(topEncoder.getVelocity(), power);
        topMotor.set(traversalPIDOUt);
        setBottom(power);
    }
    public void traverse(double power)
    {
        traversalMotor.set(ControlMode.PercentOutput,power);
    }
