...
public class SwerveDriveTrain extends SubsystemBase {
     ...
     public Vector2 calculateDrive(double x1, double y1, double theta2, double r2) {
          ...
          // Args are theta, r
          return cartesianToPolar(driveCoordinate.getX() + twistCoordinate.getX(), driveCoordinate.getY() + twistCoordinate.getY());
     }
     ...
     public void drive(double inputX, double inputY, double inputTwist) {
          ...
          Vector2 frontRightVector = calculateDrive(inputX, inputY, Constants.twistAngleMap.get("frontRight"), inputTwist);
          Vector2 frontLeftVector = calculateDrive(inputX, inputY, Constants.twistAngleMap.get("frontLeft"), inputTwist);
          Vector2 backRightVector = calculateDrive(inputX, inputY, Constants.twistAngleMap.get("backRight"), inputTwist);
          Vector2 backLeftVector = calculateDrive(inputX, inputY, Constants.twistAngleMap.get("backLeft"), inputTwist);
